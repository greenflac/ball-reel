...
* тестов **631**, мутаций **56** (было записано 214 и 15/23 в разных местах);
...
| `tests/` (**26 файлов**, см. ниже) | Арифметика и вердикты без моделей и сети: синтетические скелеты, эмбеддинги, кадры; модельные швы заглушены. **631 тест, проходят за ~46 c** (замер 2026-08-14; из них 1 пропущен). | unittest | нет |
...
Реальный вывод `--quick` (2026-08-14):
