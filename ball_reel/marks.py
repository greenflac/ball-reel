...
#:
#: Различить их по-настоящему умела бы посегментная разметка тела на десятки
#: классов, но готового кандидата с приемлемой лицензией на эту задачу нет —
#: см. `PRIOR_ART.md`, раздел 2. Доступное приближение — не подходить к
#: силуэту: чужая конечность видна возле края, середина обхвата принадлежит
#: своей. То же число и по той же причине
