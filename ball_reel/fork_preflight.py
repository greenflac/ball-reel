...
#: Размер базы 14B по ступеням, ГБ. РАСЧЁТ, не замер: 14e9 параметров умножить
#: на байты на параметр. bf16 — 2 байта, fp8 — 1, uint4 — 0.5.
TRAIN_BASE_GB = {"bf16": 28.0, "fp8": 14.0, "uint4": 7.0}

#: Обучаемых параметров LoRA ранга 32 на целевых модулях вендора.
#: РАСЧЁТ по геометрии, проверяемый: 40 блоков, в каждом q,k,v,o по 5120×5120
...
#: РАСЧЁТ, не замер, и разброс между режимами здесь ГЛАВНОЕ: обучение на кадрах
