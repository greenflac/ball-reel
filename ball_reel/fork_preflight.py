...
#: (`docs/FORK_HARDWARE.md` §9, таблица стека), НЕ ЗАМЕР ЗАНЯТОЙ ПАМЯТИ:
...
#: Формула — `docs/FORK_HARDWARE.md` §5: `(4·N·dim + N·ffn)·2 байта` по числу
...
#: названные по порядку величины (`docs/LORA_RUNBOOK.md` помечает их «ОЦЕНКА,
