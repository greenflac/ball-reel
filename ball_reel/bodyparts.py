...
* **лицензия Apache 2.0** — без оговорок про биометрию и дипфейки. Сильный
  кандидат Sapiens2 (29 классов, соответствие поверхности) отвергнут не по
  качеству, а по лицензии: она прямо запрещает применение «for biometric
  processing» и «to create deepfakes… including impersonating any individual»,
  а у нас в гейте ArcFace и продукт порождает человека по его фотографии;
