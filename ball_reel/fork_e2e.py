...
#: ИЗМЕРЕНО 22.08.2026 замером стилизаторов: победитель — `gpt-image-2` через
#: `pollinations.compose` ДВУМЯ картинками (первая на личность, вторая на
#: стиль). Попадание в стиль 0.8801 при поле 0.6409; личность 0.0652 при
#: планке 0.35. Текстовый путь ОТВЕРГНУТ: 0.6773 против того же пола 0.6409 —
#: это шум, а не стиль.
STYLE_MODEL = "gpt-image-2"
STYLE_ROUTE = "pollinations.compose"
STYLE_IMAGES = 2
STYLE_HIT_REFERENCE = 0.8801
