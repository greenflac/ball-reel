...
пересказывался. Полностью — `docs/internal/FORK_NUMBERS.md`.
...
ACCEPTANCE_ROWS = {
    "против сырой фотографии": {
        ...
        "why": ("сырой фотографии НЕТ в дереве. Манифест "
                "`demo/lora_dataset/manifest.json` прямо говорит, что якорь "
    ...
    "против медоида": {
        ...
        "why": ("воспроизведено точно, до четвёртого знака, командой "
                "`python3 -m unittest ball_reel.tests.test_fork_identity`. "
