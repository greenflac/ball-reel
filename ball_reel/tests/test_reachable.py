...
STANDALONE = {
    ...
    "research_contract": "проверка отчёта ресёрч-агента, запускается человеком "
                         "и из CI над текстом отчёта; в конвейере генерации "
                         "ему нечего делать — он про внешние источники",
